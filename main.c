...
enum
{
    EOF_T, PLUS_T, MINUS_T, MULT_T, DIV_T, INTLIT_T, SEMI_T, EQUALS_T, IDENT_T, PRINT_T, INT_T, READ_T
};

enum
{
    PLUS_A, MINUS_A, MULT_A, DIV_A, INTLIT_A, IDENT_A, LVIDENT_A, ASSIGN_A
};

char* syms = {"+", "-", "*", "/", "int", "identifier", "lval", "assignment"};
